  ...
  <div class="wrapper">
    ...
    <form method="post" action="suggest.php">
      <table>
        <tr>
          ...
          <td><input type="text" name="name" id="name" placeholder="Name" value="<?php if (isset($name)) {
    echo $name;
}
    ?>" required/></td>
        </tr>
        <tr>
          ...
          <td><input type="text" name="email" id="email" placeholder="Email" value="<?php if (isset($email)) {
    echo $email;
}
    ?>" required/></td>
        </tr>
    ...
    ?>>Music</option>
        ...
        <tr>
          ...
          <td><input id="title" type="title" name="title" placeholder="Title" value="<?php if (isset($title)) {
    echo $title;
}
    ?>" required/></td>
        </tr>
    ...
    ?>>Rock</option>
      ...
      <tr>
        ...
        <td><input id="year" type="text" name="year" placeholder="YYYY" value="<?php if (isset($year)) {
    echo $year;
}
    ?>" /></td>
      </tr>
